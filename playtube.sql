...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2022 at 05:20 PM
...
(266, 'MailruAppId', ''),
(267, 'MailruAppkey', ''),
(268, 'mailru_login', 'off'),
(269, 'discord_login', 'off'),
(270, 'wechat_login', 'off'),
(271, 'qq_login', 'off'),
(272, 'instagram_login', 'off'),
(273, 'vkontakte_login', 'off'),
(274, 'linkedin_login', 'off');
...
(496, 'geo_blocking', 'Geo Blocking', 'Geo-Blocking', 'الحظر الجغرافي', 'Geo-blokkering', 'Géolocalisation', 'Geo-Blockierung', 'Геоблокировка', 'Bloqueo geográfico', 'Coğrafi engelleme'),
...
(739, 'expand', '', 'Expand', 'يوسع', 'Uitbreiden', 'Développer', 'Erweitern', 'Расширять', 'Expandir', 'Genişletmek'),
(740, 'my_account', '', 'My Account', 'حسابي', 'Mijn rekening', 'Mon compte', 'Mein Konto', 'Мой счет', 'Mi cuenta', 'Hesabım'),
(741, 'vid_play', '', 'Play', 'لعب', 'Toneelstuk', 'Jouer', 'Spielen', 'Играть', 'Tocar', 'Oyna'),
(742, 'play_list_item', '', 'Playlist Items', 'عناصر قائمة التشغيل', 'Afspeellijstitems', 'Articles de playlist', 'Playlist-Artikel', 'Элементы плейлиста', 'Artículos de lista de reproducción', 'Çalma listesi öğeleri'),
(743, 'login_with', '', 'Login with', 'تسجيل الدخول مع', 'Login met', 'Connectez-vous avec', 'Einloggen mit', 'Зайдите в учетную запись, используя', 'Iniciar con', 'İle giriş'),
(744, 'contact_help', '', 'Help', 'يساعد', 'Hulp', 'Aider', 'Hilfe', 'Помощь', 'Ayuda', 'Yardım'),
(745, 'clear_chat', '', 'Clear Chat', 'دردشة واضحة', 'Wissen', 'Chat clair', 'Chat löschen', 'Чистый чат', 'Vacie la conversacion', 'Sohbeti temizle'),
(746, 'upload_details', '', 'Details', 'تفاصيل', 'Details', 'Détails', 'Einzelheiten', 'Подробности', 'Detalles', 'Detaylar'),
(747, 'upload_elements', '', 'Video Elements', 'عناصر الفيديو', 'Video-elementen', 'Éléments vidéo', 'Videoelemente', 'Видеоэлементы', 'Elementos de video', 'Video öğeleri'),
(748, 'upload_visibility', '', 'Visibility', 'الرؤية', 'Zichtbaarheid', 'Visibilité', 'Sichtweite', 'Видимость', 'Visibilidad', 'Görünürlük'),
(749, 'import_subhead', '', 'One Steps Video Upload', 'خطوات واحدة تحميل الفيديو', 'Eén stappen Video Upload', 'Un téléchargement vidéo d\'une étape', 'Ein Schritten Video-Upload', 'Один шагов видео загрузка', 'Subir video de un paso', 'Bir adım video yükleme'),
(750, 'upload_subhead', '', '3 Steps Video Upload', '3 خطوات تحميل الفيديو', '3 stappen video-upload', '3 étapes Téléchargement de vidéos', '3 Schritte Video-Upload', '3 шагов видео загрузка', '3 pasos de video Subir', '3 Adım Video Yükleme'),
(751, 'darg_drop_to_upload', '', 'Drag and drop video files to upload', 'سحب وإسقاط ملفات الفيديو لتحميل', 'Sleep videobestanden naar uploaden en neerzetten', 'Faites glisser et déposer des fichiers vidéo pour télécharger', 'Drehen Sie Videodateien, um das Upload zu hochzuladen', 'Перетащите видеофайлы для загрузки', 'Arrastrar y soltar archivos de video para subir.', 'Yüklemek için video dosyalarını sürükleyip bırakın'),
(752, 'videos_will_private', '', 'Your videos will be private until you publish them.', 'ستكون مقاطع الفيديو الخاصة بك خاصة حتى تنشرها.', 'Je video\'s zijn privé totdat je ze publiceert.', 'Vos vidéos seront privées jusqu\'à ce que vous les publiez.', 'Ihre Videos sind privat, bis Sie sie veröffentlichen.', 'Ваши видео будут частными, пока вы не опублилируете их.', 'Tus videos serán privados hasta que los publique.', 'Videoları yayınlayana kadar videolarınız özel olacak.'),
(753, 'use_url_import', '', 'Use Video URL and Import Video', 'استخدام عنوان URL للفيديو واستيراد الفيديو', 'Gebruik Video-URL en importeer video', 'Utilisez URL vidéo et importer une vidéo', 'Verwenden Sie Video-URL und importieren Sie Video', 'Используйте видео URL и импорт видео', 'Usa la URL de video e importar video', 'Video URL\'si kullanın ve video içe aktarın'),
(754, 'next_step', '', 'Next Step', 'الخطوة التالية', 'Volgende stap', 'L\'étape suivante', 'Nächster Schritt', 'Следующий шаг', 'Próximo paso', 'Sonraki adım'),
(755, 'what_you_uploading', '', 'What are you uploading?', 'ماذا تفعل تحميل؟', 'Wat upload je?', 'Que téléchargez-vous?', 'Was machst du hoch?', 'Что ты загружаешь?', '¿Qué estás subiendo?', 'Ne yükliyorsun?'),
(756, 'go_back', '', 'Go Back', 'عد', 'Ga terug', 'Retourner', 'Geh zurück', 'Вернись', 'Regresa', 'Geri gitmek'),
(757, 'no_video_issue', '', 'Video upload complete. No issues found.', 'تحميل الفيديو كاملة. ', 'Video-upload compleet. ', 'Téléchargement de vidéos complète. ', 'Video-Upload komplett. ', 'Загрузить видео загрузку. ', 'Carga de video completa. ', 'Video yükleme tamamlandı. '),
(758, 'video_link', '', 'Video Link', 'رابط الفيديو', 'Video link', 'Lien vidéo', 'Video-Link', 'Видео ссылка', 'Enlace de video', 'Video bağlantısı'),
(759, 'file_name', '', 'File Name', 'اسم الملف', 'Bestandsnaam', 'Nom de fichier', 'Dateinamen', 'Имя файла', 'Nombre del archivo', 'Dosya adı'),
(760, 'upload_video_thumb_desc', '', 'Select or upload a picture that shows what\'s in your video. A good thumbnail stands out and draws viewers\' attention', 'حدد أو تحميل صورة توضح ما هو في الفيديو الخاص بك. ', 'Selecteer of upload een foto die laat zien wat er in uw video staat. ', 'Sélectionnez ou téléchargez une image qui indique ce qui est dans votre vidéo. ', 'Wählen Sie ein Bild aus, das zeigt, was in Ihrem Video in Ihrem Video ist. ', 'Выберите или загрузите изображение, которое показывает, что в вашем видео. ', 'Seleccione o cargue una imagen que muestre lo que hay en su video. ', 'Videonuzda ne olduğunu gösteren bir resim seçin veya yükleyin. '),
(761, 'upload_video_trailer_desc', '', 'You can upload a trailer for your movie.', 'يمكنك تحميل مقطورة لفيلمك.', 'U kunt een trailer uploaden voor uw film.', 'Vous pouvez télécharger une remorque pour votre film.', 'Sie können einen Trailer für Ihren Film hochladen.', 'Вы можете загрузить трейлер для вашего фильма.', 'Puedes subir un trailer para tu película.', 'Filminiz için bir römork yükleyebilirsiniz.'),
(762, 'add_tags_to_your_video', '', 'Add tags to your video', 'أضف علامات إلى الفيديو الخاص بك', 'Tags toevoegen aan je video', 'Ajouter des tags à votre vidéo', 'Fügen Sie Ihrem Video Tags hinzu', 'Добавить теги на ваше видео', 'Añadir etiquetas a tu video', 'Videonuza Etiketler Ekleyin'),
(763, 'add_sub_category_to_your_video', '', 'Add sub category to your video', 'أضف فئة فرعية إلى الفيديو الخاص بك', 'Voeg subcategorie toe aan uw video', 'Ajouter une catégorie à votre vidéo', 'Fügen Sie Ihrem Video Unterkategorie hinzu', 'Добавьте подпунктивную категорию на ваше видео', 'Agregue la subcategoría a su video', 'Videonuza Alt Kategori Ekle'),
(764, 'add_category_to_your_video', '', 'Add category to your video', 'إضافة فئة إلى الفيديو الخاص بك', 'Voeg categorie toe aan uw video', 'Ajouter une catégorie à votre vidéo', 'Fügen Sie Ihrem Video Kategorie hinzu', 'Добавить категорию на ваше видео', 'Añadir categoría a su video', 'Videonuza kategori ekle'),
(765, 'choose_the_video_privacy', '', 'Choose the video privacy', 'اختيار خصوصية الفيديو', 'Kies de videoprivacy', 'Choisissez la vidéo Confidentialité', 'Wählen Sie das Video-Datenschutz', 'Выберите конфиденциальность видео', 'Elige la privacidad de video', 'Video gizliliğini seçin'),
(766, 'upload_normal_video_text', '', 'Upload a normal video', 'تحميل الفيديو العادي', 'Upload een normale video', 'Téléchargez une vidéo normale', 'Laden Sie ein normales Video hoch', 'Загрузить нормальное видео', 'Sube un video normal', 'Normal bir video yükle'),
(767, 'upload_normal_movie_text', '', 'Upload a movie', 'تحميل فيلم', 'Upload een film', 'Télécharger un film', 'Laden Sie einen Film hoch', 'Загрузить фильм', 'Subir una película', 'Bir film yükle'),
(768, 'upload_normal_stock_video_text', '', 'Upload a stock video', 'حمل فيديو الأسهم', 'Upload een stockvideo', 'Télécharger une vidéo en stock', 'Laden Sie ein Stock Video hoch', 'Загрузить акции видео', 'Sube un almacen de video', 'Bir stok video yükle'),
(769, 'geo_blocking', '', 'Geo-Blocking', 'الحظر الجغرافي', 'Geo-blokkering', 'Géolocalisation', 'Geo-Blockierung', 'Геоблокировка', 'Bloqueo geográfico', 'Coğrafi engelleme'),
(770, 'refund_policy', '', 'Refund Policy', 'سياسة الاسترجاع', 'Restitutiebeleid', 'Politique de remboursement', 'Rückgaberecht', 'Политика возврата', 'Politica de reembolso', 'Geri ödeme politikası'),
(771, 'faqs', '', 'FAQs', 'أسئلة وأجوبة', 'Veelgestelde vragen', 'Faqs', 'FAQs', 'Часто задаваемые вопросы', 'Preguntas frecuentes', 'SSS'),
(772, 'get_back_soon', '', 'We’ll be back soon!', 'سنعود قريبا!', 'We zullen snel terug zijn!', 'Nous reviendrons bientôt!', 'Wir werden bald zurück sein!', 'Мы скоро вернемся!', '¡Estaremos de vuelta pronto!', 'Yakında döneceğiz!'),
(773, 'maintenance_text', '', 'Sorry for the inconvenience but we performing some maintenance at the moment. If you need help you can always', 'آسف للإزعاج لكننا نؤدي بعض الصيانة في الوقت الحالي. ', 'Sorry voor het ongemak, maar we uitvoeren op dit moment wat onderhoud. ', 'Désolé pour le désagrément occasionné, mais nous effectuons un peu de maintenance pour le moment. ', 'Entschuldigung für die Unannehmlichkeiten, aber wir haben im Moment etwas Wartung. ', 'Извините за неудобства, но мы выполняем некоторое обслуживание в данный момент. ', 'Lo siento por los inconvenientes, pero realizamos algún mantenimiento en este momento. ', 'Rahatsızlık için özür dilerim ama şu anda biraz bakım yapıyoruz. '),
(774, 'well_be_back_shortly', '', 'otherwise, we will be back online shortly!', 'خلاف ذلك، سنعود عبر الإنترنت قريبا!', 'Anders zullen we binnenkort online zijn!', 'Sinon, nous serons de retour en ligne sous peu!', 'Ansonsten werden wir kurz online sein!', 'В противном случае мы вернемся в ближайшее время!', 'De lo contrario, volveremos en línea en breve!', 'Aksi takdirde, kısa sürede çevrimiçi olacağız!'),
(775, 'published_in', '', 'Published in', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
